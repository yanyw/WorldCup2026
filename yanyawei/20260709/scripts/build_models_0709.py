#!/usr/bin/env python3
"""Build independent P1/P2/P3 forecasts for the 2026-07-09 France-Morocco match.
...
P3_PATH = DATA_DIR / "fifa_match_stats_0709.json"
OUTPUT_PATH = DATA_DIR / "model_results_0709.json"
BACKTEST_PATH = DATA_DIR / "model_backtest_0709.json"

TARGETS = [
    {
        "id": "france_morocco_2026-07-09",
        "home": "France",
        "away": "Morocco",
        "neutral": True,
        "venue": "2026 World Cup quarter-final venue",
