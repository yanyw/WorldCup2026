...
MODEL_PATH = ROOT / "data" / "model_results_0711.json"
EVIDENCE_PATH = ROOT / "data" / "external_evidence_0711.json"
MARKET_PATH = ROOT / "data" / "polymarket_snapshot_0711.json"
POLICY_PATH = ROOT.parent / "workflow_policy.json"
OUTPUT_PATH = ROOT / "data" / "candidate_evaluation_0711.json"
BANKROLL = 1000.0
...
def main() -> None:
    ...
    market_ids = {
        "fifwc-nor-eng-2026-07-11": "norway_england_2026-07-11",
        "fifwc-arg-che-2026-07-11": "argentina_switzerland_2026-07-11",
    }
    ...
    data_quality_penalty = float(params["data_quality_penalty"])
