...
MODEL_PATH = ROOT / "data" / "model_results_0718.json"
EVIDENCE_PATH = ROOT / "data" / "external_evidence_0718.json"
MARKET_PATH = ROOT / "data" / "polymarket_snapshot_0718.json"
POLICY_PATH = ROOT.parent / "workflow_policy.json"
OUTPUT_PATH = ROOT / "data" / "candidate_evaluation_0718.json"
BANKROLL = 1000.0
...
def main() -> None:
    ...
    market_ids = {
        "fifwc-fra-eng-2026-07-18": "france_england_2026-07-18",
